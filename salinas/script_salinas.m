...
plot_ber = [plot, aber_mrmr, aber_jmi, aber_mcm, aber_relief, aber_pca];
save -ascii 'plot_data_ber' plot_ber

plot_r = [0.70; 0.75; 0.80; 0.85; 0.90; 0.95];
...
plot_r_ber = [plot_r, aber_mrmr_r, aber_jmi_r, aber_mcm_r, aber_relief_r, aber_pca_r];
